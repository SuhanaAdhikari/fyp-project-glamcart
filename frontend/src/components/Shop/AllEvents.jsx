            ...
            <div className="flex gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 rounded-xl border border-gray-300 focus:ring-2 focus:ring-pink-400 outline-none"
                />
              </div>
        ...
        <div className="gc_card overflow-hidden">
          ...
          {rows.length === 0 ? (
            <div className="py-20 text-center">
              <FiCalendar size={36} className="mx-auto text-pink-500 mb-4" />
